...
const Counter = ({ id, name, minQuantity }) => {
  ...
  let addToCart = (
    <button
      ...
      className="flex flex-row justify-around items-center py-1 w-full md:px-8 text-sm  bg-green-700 text-yellow rounded-tl-xl rounded-tr-xl"
    >
    ...
    addToCart = (
      <>
        <button
          ...
          className="px-3 md:px-8 py-1 text-lg bg-green-700 text-yellow rounded-sm rounded-tl-xl"
        >
          <FiMinusSquare />
        </button>
        ...
        <button
          onClick={() => dispatch(quantityUp(id, name, +minQuantity))}
          className="px-3 md:px-8 py-1 text-lg bg-green-700 text-yellow rounded-sm rounded-tr-xl"
        >
          <FiPlusSquare />
        </button>
      </>
